...
func main() {
	...
	if err := injector.NewMutatingWebhook(injectorConfig, kubeClient, certManager, newCatalog, newCatalog, meshName, osmNamespace, webhookConfigName, stop, cfg); err != nil {
